...
app.put("/updateuser/:UserId",(req,res)=>{
    ...
    mongoClient.connect(conString).then(response=>{
        var database = response.db("videotutorials");
        database.collection("tblusers").updateOne({UserId:UserId},{$set:{UserId:req.body.UserId, UserName:req.body.UserName, Password:req.body.Password,Email:req.body.Email,Mobile:req.body.Mobile}}).then(()=>{
